  ...
  return (
    <main className="landing-root min-h-screen bg-zon-surface text-zon-dark antialiased relative overflow-x-hidden selection:bg-zon-lime selection:text-zon-primary">
      <nav className="fixed top-0 w-full z-50 glass-nav border-b border-zon-dark/5 bg-zon-surface/90">
        <div className="flex justify-between items-center h-20 px-6 md:px-10 max-w-[1440px] mx-auto w-full">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex gap-8 items-center">
              <a
                href="#features"
                className="text-sm font-semibold tracking-wide text-zon-dark border-b-2 border-transparent hover:border-zon-primary pb-1 transition-all duration-200"
              >
                Features
              </a>
              <a
      ...
      <main className="pt-20">
        <section className="hero-gradient min-h-screen flex flex-col items-center justify-center text-center px-6 pt-24 pb-16 relative overflow-hidden">
          ...
          <div className="max-w-[850px] mx-auto z-10">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-zon-dark tracking-tighter leading-[1.05] mb-6">
              Time Management
              <br />
              ...
              <div className="grid grid-cols-12 gap-6 items-stretch">
                <div className="col-span-12 lg:col-span-4 bg-white/5 backdrop-blur-xl rounded-2xl p-6 text-left border border-white/10 flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="p-4 bg-white/5 rounded-xl border border-zon-lime/20">
                    ...
                    <div className="pt-4 border-t border-white/10">
                      <button
                        onClick={openLogin}
                        className="w-full py-3 bg-zon-lime text-zon-primary rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-white hover:text-zon-dark transition-all duration-300 active:scale-95 shadow-lg shadow-zon-lime/5"
                      >
                ...
                <div className="col-span-12 lg:col-span-8 overflow-hidden rounded-2xl bg-black relative min-h-[380px] flex flex-col justify-end">
                  ...
                  <div className="relative p-6 sm:p-8 text-left z-10">
                    ...
                    <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tighter max-w-[500px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-12">
                <div>
                  ...
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tighter text-zon-dark leading-none">
                    Engineered for
                    <br />
        ...
        <section id="testimonials" className="py-24 px-6 max-w-[1440px] mx-auto overflow-hidden">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-center mb-16 tracking-tighter text-zon-dark">
            Loved by Creators.
          </h2>
        ...
        <section id="pricing" className="py-24 px-6 bg-zon-charcoal text-white relative overflow-hidden">
          ...
          <div className="max-w-[1440px] mx-auto relative z-10">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 tracking-tighter">
              ...
              <div className="bg-white/5 backdrop-blur-md p-8 sm:p-10 rounded-3xl border border-white/10 flex flex-col justify-between hover:border-white/20 transition-all duration-300">
                <div>
                  ...
                  <div className="text-4xl sm:text-5xl font-black mb-8 text-white flex items-baseline">
                    INR 0
                    <span className="text-xs sm:text-sm font-semibold opacity-40 ml-2">/ 14 days</span>
                  </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 mb-16">
            <div className="col-span-2 md:col-span-1 space-y-4">
              <span className="text-xl sm:text-2xl font-extrabold text-zon-dark block tracking-tighter">Zoned</span>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6 pt-10 border-t border-zon-dark/5">
            ...
            <div className="flex gap-4 items-center">
              <Link href="/" className="text-xs font-semibold text-zon-on-variant/70 hover:text-zon-primary">Open Dashboard</Link>
